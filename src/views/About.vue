<template>
  <div class="about emulated-flex-gap">
    <div>
    <h1>About me</h1>
    <h5>
    ...
    <p>
      I'm Antonio Dell'Annunziata, proud owner and creator of this beautifully
      minimalstic - some call it cheap, but we don't speak about THEM - webpage.
